module Phone_type2
(Phone(phoneType, countryCode, phoneNo), PhoneType, CountryCode, PhoneNo, fromPhoneNo, toPhoneNo, readPhone, onlyDigits, removeExcess, checkPhoneType, toCountryCode, predefinedCountryCodes, phoneNro) where
